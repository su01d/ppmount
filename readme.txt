...
OPTIONS:
  ...
  -a, --all	         Mounts all unmounted devices, that have a filesystem
  -d, --device <device>  Mounts a single device by its name (e.g. sdb or sdc4, without '/dev/')	
  -l, --label <label>    Mounts a single device by its label
